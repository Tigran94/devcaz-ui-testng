...
public class ConsoleColors {
    ...
    static final String YELLOW_BOLD = "\033[1;33m"; // YELLOW
    ...
    static final String WHITE_BOLD = "\033[1;37m";  // WHITE

    // Underline
    static final String BLACK_UNDERLINED = "\033[4;30m";  // BLACK
    static final String RED_UNDERLINED = "\033[4;31m";    // RED
    static final String GREEN_UNDERLINED = "\033[4;32m";  // GREEN
    static final String YELLOW_UNDERLINED = "\033[4;33m"; // YELLOW
    static final String BLUE_UNDERLINED = "\033[4;34m";   // BLUE
    static final String PURPLE_UNDERLINED = "\033[4;35m"; // PURPLE
    static final String CYAN_UNDERLINED = "\033[4;36m";   // CYAN
    static final String WHITE_UNDERLINED = "\033[4;37m";  // WHITE
    ...
    static final String BLACK_BACKGROUND_BRIGHT = "\033[0;100m";// BLACK
    static final String RED_BACKGROUND_BRIGHT = "\033[0;101m";// RED
    static final String GREEN_BACKGROUND_BRIGHT = "\033[0;102m";// GREEN
    static final String YELLOW_BACKGROUND_BRIGHT = "\033[0;103m";// YELLOW
    static final String BLUE_BACKGROUND_BRIGHT = "\033[0;104m";// BLUE
    static final String PURPLE_BACKGROUND_BRIGHT = "\033[0;105m"; // PURPLE
    static final String CYAN_BACKGROUND_BRIGHT = "\033[0;106m";  // CYAN
    static final String WHITE_BACKGROUND_BRIGHT = "\033[0;107m";   // WHITE
